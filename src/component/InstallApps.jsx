...
import {  removeFromLs } from "./addToDb";
const InstallApps = ({ b,  handleRemove }) => {
  ...
  return (
    <div className="max-sm:flex max-sm:mx-5  lg:flex justify-between items-center border-0 bg-white p-5 rounded-sm mx-20 mb-5  ">
      <div className="flex gap-5">
        ...
        <div>
          <h2 className="font-medium text-[20px] text-[#001931] mb-3">
            {b.title}
          </h2>
      ...
      <div>
        <button
          ...
          className="border-0 rounded-sm px-5 py-2 text-white font-semibold bg-[#00D390]"
        >
          Uninstall
        </button>
      </div>
